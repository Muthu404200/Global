...
const WhyChooseData = [
  ...
  },
  {
    id: 3,
    title: "Workshops",
    desc: "Workshops are hands-on meetings, as opposed to lectures or presentations that primarily consist of listening to a speaker. ",
    link: "/",
    icon: <GiGymBag />,
    bgColor: "#fa6400",
    delay: 0.9,
          ...
          {WhyChooseData.map((item) => {
            return (
              <motion.div
                ...
                initial="hidden"
                whileInView={"visible"}
                className="space-y-4 p-6 rounded-xl shadow-[0_0_22px_rgba(0,0,0,0.15)] hover:text-secondary transition-all duration-300"
              >
                {/* icon section */}
                <div
