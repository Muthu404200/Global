...
import { FaTwitter, FaLinkedinIn, FaInstagram , FaPhone, FaBars, FaTimes , FaFacebookF} from 'react-icons/fa';
      ...
      >
        <div className="container flex justify-between items-center py-6">
          ...
          <div className="hidden lg:block space-x-6">
            <ul className="flex text-gray-600 gap-6 items-center cursor-pointer">
